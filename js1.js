...
function finish() 
{
	...
	if(document.getElementById('confirmbuttonn').classList.contains('choosed') && document.getElementById('confirmbuttonn').value != "Продолжить") 
	{
		if(clicked == 1) {
			...
			answer.innerHTML = "Ничем не могу помочь"
		...
		if(clicked == 2) {
			...
			buttonn2.style.border = "solid #3fff00"
			answer.innerHTML = "Правильный ответ! Это было так сложно, не правда ли?!"
